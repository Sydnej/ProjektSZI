...
public class C45 {
    ...
    public void C45() {
        ...
        do {
            ...
            FileParser filePaser = new FileParser(getClass().getResource("Data.txt").getFile());
            ...
            decisionTree = new DecisionTree(trainingSet, filePaser.getAttributes(), filePaser.getNumberOfOutput());
